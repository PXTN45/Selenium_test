...
class TC_02_EnterThaiEmail {
	...
	void test02() throws InterruptedException {
		...
		driver.findElement(By.xpath("//*[@id=\"username\"]")).sendKeys("นัทธพงศ์");
		driver.findElement(By.xpath("//*[@id=\"passwd\"]/div[1]/div/div[1]/input")).sendKeys("Pat123456");
		...
		assertEquals("ขออภัย อนุญาตให้ใช้เฉพาะตัวอักษร (a-z), ตัวเลข (0-9), และเครื่องหมายมหัพภาค (.) เท่านั้น", result);
		//Thread.sleep(4000);
		driver.close();
