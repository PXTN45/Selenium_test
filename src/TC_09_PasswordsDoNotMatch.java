...
class TC_09_PasswordsDoNotMatch {
	...
	void test09() throws InterruptedException {
		...
		driver.findElement(By.xpath("//*[@id=\"confirm-passwd\"]/div[1]/div/div[1]/input")).sendKeys("Pat1234");
		...
		assertEquals("รหัสผ่านไม่ตรงกัน ลองอีกครั้ง", result);
		Thread.sleep(2000);
		driver.close();
