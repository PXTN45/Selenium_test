...
class TC_01_DuplicateEmail {
	...
	void test01() throws InterruptedException {
		...
		driver.findElement(By.xpath("//*[@id=\"username\"]")).sendKeys("Nattaphong12345");
		...
		assertEquals("ชื่อผู้ใช้นั้นมีผู้อื่นใช้แล้ว ลองใช้ชื่ออื่น", result);
		Thread.sleep(4000);
		driver.close();
